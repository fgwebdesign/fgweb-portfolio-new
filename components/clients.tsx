  ...
  return (
    <section id="clients" className="py-24 lg:py-32 bg-background border-t border-foreground/10">
      <div ref={sectionRef} className="max-w-[1600px] mx-auto px-6 lg:px-12">
        ...
        {/* Stats */}
        <motion.div
          className="mt-20 lg:mt-32 pt-12 border-t border-foreground/10 grid grid-cols-2 lg:grid-cols-4 gap-8"
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          <div>
            <motion.p
              className="text-[clamp(2rem,6vw,4rem)] font-bold leading-none mb-2"
